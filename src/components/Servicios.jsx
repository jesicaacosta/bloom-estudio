  ...
  return (
    ...
    <section id="servicios" className="bg-white py-24 px-6">
      ...
      <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
        ...
        {/* Tarjeta 1: Básico */}
        <div className="bg-rose-50 border border-rose-100 rounded-2xl shadow hover:shadow-lg transition p-8 text-center">
          <h3 className="text-xl font-semibold text-rose-700 mb-4">Paquete Básico</h3>
        ...
        <div className="bg-rose-100 border border-rose-200 rounded-2xl shadow hover:shadow-lg transition p-8 text-center">
          <h3 className="text-xl font-semibold text-rose-700 mb-4">Paquete Intermedio</h3>
          <p className="text-neutral-600 mb-6">
        ...
        {/* Tarjeta 3: Premium */}
        <div className="bg-rose-200 border border-rose-300 rounded-2xl shadow hover:shadow-lg transition p-8 text-center">
          <h3 className="text-xl font-semibold text-rose-700 mb-4">Paquete Premium</h3>
          <p className="text-neutral-600 mb-6">
