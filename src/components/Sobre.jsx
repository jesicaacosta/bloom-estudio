      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-neutral-700 leading-relaxed mb-4">
            ...
            y genere un 
            <span className="font-semibold text-rose-600"> impacto positivo en sus vidas.</span>.
          </p>

          <p className="text-neutral-700 leading-relaxed mb-4">
            Creo en la claridad, la autenticidad y la creatividad como pilares para
            construir marcas digitales que transmitan confianza y atraigan a las
            clientas correctas.
          </p>

          <p className="text-neutral-700 leading-relaxed">
            Mi enfoque combina <span className="font-semibold">estrategia + estética + cercanía</span>,
